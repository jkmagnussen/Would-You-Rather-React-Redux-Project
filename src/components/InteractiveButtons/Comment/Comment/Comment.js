...
class Comment extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      commentReplyCount: 3,
      comment: "Thisss is ann example of text that would fill this status/ caption section. This should be relevant to the blurred images displayed beneath to somehow incentivise a particular choice.",
